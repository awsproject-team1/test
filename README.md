...
4. Manually install the platform workflow templates and canonical hash helper described in `docs/CUSTOMER_SANDBOX_ONBOARDING.md`. Configure the Plan and Apply role ARNs only in the copied workflows.
